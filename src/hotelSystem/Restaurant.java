...
public class Restaurant {
	...
	public static void roomServicePanel() {
		...
		roomServiceTitle.setBounds(170, 0, 140, 25);
		menuTitle.setBounds(10, 80, 140, 25);
		scrollPane.setBounds(170, 50, 140, 100);
		AddOrder.setBounds(170, 170, 140, 25);
		menuEditTitle.setBounds(10, 220, 140, 25);
		scrollPane2.setBounds(170, 200, 140, 75);
		special.setBounds(10, 280, 140, 25);
		instructions.setBounds(10, 315, 140, 25);
		floorSelect.setBounds(170, 380, 50, 25);
		scrollPane3.setBounds(170, 280, 140, 75);
		roomSelect.setBounds(260, 380, 50, 25);
		roomNum.setBounds(10,380, 140, 25);
		order.setBounds(170, 450, 140, 25);
	...
	private static class Order implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			String room = floorSelect.getItemAt(floorSelect.getSelectedIndex()) + roomSelect.getItemAt(roomSelect.getSelectedIndex());
